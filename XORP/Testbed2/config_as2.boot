...
interfaces {
    interface eth1 {
        vif eth1 {
			address 192.168.3.1 {
	        	...
	        	address fe80::5054:ff:fee4:ce9a {
	        		prefix-length: 64
	        	}
			address 2002:db8:1600:1::1401 {
				prefix-length: 61
	        	}			      
        }
    }
    interface eth2 {
        vif eth2 {
	        ...
	        address fe80::5054:ff:fe73:b8a5 {
	        	prefix-length: 64
	        }
		address 2002:db8:1000::2 {
			prefix-length: 61
	        }			 
        }
    }
...
/*       route 8000::0/5 {
       ...
       interface-route fe80::5054:ff:fed4:3f87/128 {
           next-hop-interface: "eth1"
           next-hop-vif: "eth1"
           metric: 100
       }
